...
<style>
  /* Dot colours tuned for the Weave palette: warm ink dots on the cream
     canvas, warm cream dots on the dark canvas, so toggling is clearly
     visible (the old greys were near-invisible on cream). */
  .grid-bg-light {
    background-size: 30px 30px;
    background-image: radial-gradient(circle, rgba(21, 19, 15, 0.16) 2px, transparent 2px);
  }

  .grid-bg-dark {
    background-size: 30px 30px;
    background-image: radial-gradient(circle, rgba(236, 231, 218, 0.13) 2px, transparent 2px);
  }
</style>
