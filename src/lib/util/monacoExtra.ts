...
export const initEditor = (monacoEditor: typeof Monaco): void => {
  ...
  monacoEditor.editor.defineTheme('mermaid-dark', {
    base: 'vs-dark',
    // Match the Weave "paper" dark surface so the editor blends with the app.
    colors: {
      'editor.background': '#211e1a',
      'editorGutter.background': '#211e1a',
      'editorLineNumber.foreground': '#6b6557',
      'editorLineNumber.activeForeground': '#9a9285',
      'editor.lineHighlightBackground': '#2a2620',
  ...
  monacoEditor.editor.defineTheme('mermaid', {
    base: 'vs',
    // Match the Weave "paper" light surface (#faf8f3) instead of stark white.
    colors: {
      'editor.background': '#faf8f3',
      'editorGutter.background': '#faf8f3',
      'editorLineNumber.foreground': '#b3ac9d',
      'editorLineNumber.activeForeground': '#5d574d',
      'editor.lineHighlightBackground': '#ece8e0',
      'editor.lineHighlightBorder': '#00000000'
    },
    inherit: true,
    rules: [
